...
spec:
  ...
  location: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: Location\nstartDate: 2006-01-02\nendDate: Present\npositions:\n  - title: Title\n    startDate: StartDate1\n    endDate: EndDate1\n    highlights: Highlights"
  startDate: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: 2006-01-02\nendDate: Present\npositions:\n  - title: Title\n    startDate: StartDate1\n    endDate: EndDate1\n    highlights: Highlights"
  endDate: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: !!start parent.Spec.StartDate !!end\nendDate: Present\npositions:\n  - title: Title\n    startDate: StartDate1\n    endDate: EndDate1\n    highlights: Highlights"
  position:
    title: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: !!start parent.Spec.StartDate !!end\nendDate: !!start parent.Spec.EndDate !!end\npositions:\n  - title: Title\n    startDate: StartDate1\n    endDate: EndDate1\n    highlights: Highlights"
    startDate: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: !!start parent.Spec.StartDate !!end\nendDate: !!start parent.Spec.EndDate !!end\npositions:\n  - title: !!start parent.Spec.Position.Title !!end\n    startDate: StartDate1\n    endDate: EndDate1\n    highlights: Highlights"
    endDate: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: !!start parent.Spec.StartDate !!end\nendDate: !!start parent.Spec.EndDate !!end\npositions:\n  - title: !!start parent.Spec.Position.Title !!end\n    startDate: !!start parent.Spec.Position.StartDate !!end\n    endDate: EndDate1\n    highlights: Highlights"
    highlights: "---\nemployer: !!start parent.Spec.Employer !!end\nlocation: !!start parent.Spec.Location !!end\nstartDate: !!start parent.Spec.StartDate !!end\nendDate: !!start parent.Spec.EndDate !!end\npositions:\n  - title: !!start parent.Spec.Position.Title !!end\n    startDate: !!start parent.Spec.Position.StartDate !!end\n    endDate: !!start parent.Spec.Position.EndDate !!end\n    highlights: Highlights"
`
